 ...
 * 
 */
@WebServiceClient(name = "CalculadoraImplService", targetNamespace = "http://calculadora.ws.com/", wsdlLocation = "http://localhost:2020/WS/Calculadora?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULADORAIMPLSERVICE_QNAME = new QName("http://calculadora.ws.com/", "CalculadoraImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:2020/WS/Calculadora?wsdl");
    ...
    public ICalculadora getCalculadoraImplPort() {
        return super.getPort(new QName("http://calculadora.ws.com/", "CalculadoraImplPort"), ICalculadora.class);
    }
    ...
    public ICalculadora getCalculadoraImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://calculadora.ws.com/", "CalculadoraImplPort"), ICalculadora.class, features);
    }

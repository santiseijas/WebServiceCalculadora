 ...
 * generated in the com.ws.calculadora package. 
...
public class ObjectFactory {
    ...
    private final static QName _Resta_QNAME = new QName("http://calculadora.ws.com/", "resta");
    private final static QName _RestaResponse_QNAME = new QName("http://calculadora.ws.com/", "restaResponse");
    private final static QName _Division_QNAME = new QName("http://calculadora.ws.com/", "division");
    private final static QName _Suma_QNAME = new QName("http://calculadora.ws.com/", "suma");
    private final static QName _SumaResponse_QNAME = new QName("http://calculadora.ws.com/", "sumaResponse");
    private final static QName _Multiplicacion_QNAME = new QName("http://calculadora.ws.com/", "multiplicacion");
    private final static QName _DivisionResponse_QNAME = new QName("http://calculadora.ws.com/", "divisionResponse");
    private final static QName _MultiplicacionResponse_QNAME = new QName("http://calculadora.ws.com/", "multiplicacionResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ws.calculadora
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calculadora.ws.com/", name = "resta")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calculadora.ws.com/", name = "restaResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calculadora.ws.com/", name = "division")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calculadora.ws.com/", name = "suma")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calculadora.ws.com/", name = "sumaResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calculadora.ws.com/", name = "multiplicacion")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calculadora.ws.com/", name = "divisionResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calculadora.ws.com/", name = "multiplicacionResponse")
